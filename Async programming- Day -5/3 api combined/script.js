...
fetch("https://restcountries.com/v3.1/all")
  .then((response) => response.json())
  .then((countries) => {
    // Extract capital,flags names into the  array
    ...
    for (i = 0; i < capitalNames.length; i++) {
      ...
      // Fetch data from the  openweathermapAPI
  ...
  // Extract relevant information from the news data and display in the card
...
function displayNewsData(data) {
  ...
  for(i=0;i<articles.length;i++) {
    // check weather given data has null or not
    if (
...
// Extract relevant information from the coinAPI data and display in the card
...
function displayCoinData(data) {
 ...
 // Extract relevant information from the weather data and display in the card
